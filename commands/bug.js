...
module.exports = {
    name: "bug",
    author: "leozin",
    servidor: "https://discord.gg/PDKYM5pF2Z",

    run: async(client, message, args) => {
        let ferinha_canal_de_bugs = client.channels.cache.get("917196456618774529"); //ID DO CANAL DE BUGS
