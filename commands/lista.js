/*
Comando do vídeo, por FERINHA! --- Créditos do script no vídeo.
Utilize no terminal: npm install ytdl-core@latest
*/

const { MessageEmbed } = require("discord.js");
let cor_embed/*ferinha*/= "FF0000"; // Coloque a cor da embed aqui!
