...
module.exports = {
    name: "addbot",
    author: "leozin",
    servidor: "https://discord.gg/zXeFXKmGNJ",
    
    run: async(client, message, args) => {

let prefixo = "-"; //coloque o prefixo do seu bot

let canal_ferinha = message.guild.channels.cache.find(ch => ch.id === "917234187587686452"); //coloque canal de logs
...
let emoji_certo = "✅";
let emoji_add = "➕";
let cor_embeds = "#009dff"; //coloque a cor das embeds que o bot enviará
let emoji_bot = "🤖";
let emoji_user = "👤";
let emoji_na_dm = "🗂";
...
.setDescription(`${emoji_add} Clique [aqui](https://discord.com/oauth2/authorize?client_id=842019515281833984&scope=bot&permissions=581748924478) para adicionar o bot.`)
.setColor(cor_embeds)
.addFields(
  {
